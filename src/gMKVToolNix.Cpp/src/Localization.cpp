...
QMap<QString, QString> JsonLocalizationService::defaultEnglishDefaults()
{
    return {
        ...
        { QStringLiteral("UI.MainForm2.Config.LinuxToolsDialogTitle"), QStringLiteral("Select mkvmerge") },
        { QStringLiteral("UI.MainForm2.Config.LinuxToolsLabel"), QStringLiteral("MKV tools:") },
        { QStringLiteral("UI.MainForm2.Config.LinuxToolsPlaceholder"), QStringLiteral("Auto-detect from PATH or choose mkvmerge") },
        { QStringLiteral("UI.MainForm2.Config.LinuxToolsTitle"), QStringLiteral("MKV tools") },
        { QStringLiteral("UI.MainForm2.Config.WindowsPathDialogTitle"), QStringLiteral("MKVToolNix Path") },
        { QStringLiteral("UI.MainForm2.Config.WindowsPathLabel"), QStringLiteral("MKVToolNix Path:") },
        { QStringLiteral("UI.MainForm2.Config.WindowsPathPlaceholder"), QStringLiteral("MKVToolNix path") },
        { QStringLiteral("UI.MainForm2.Config.WindowsToolsTitle"), QStringLiteral("MKVToolNix") },
